...
def is_winner(current_row_index, current_col_index, board):
    for direction, coords in DIRECTION_MAPPER.items():
        ...
        travel_direction_count = travel_direction(coords, current_row_index, current_col_index, searched_element, "+",
                                                  board)
        travel_opposite_direction_count = travel_direction(coords, current_row_index, current_col_index,
